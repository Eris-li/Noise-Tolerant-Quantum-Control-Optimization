...
def main() -> None:
    ...
    fit = json.loads((artifacts / "closed_system_cz_v2_two_stage_fit.json").read_text(encoding="utf-8"))
    ...
    ax.set_title("Closed-system corrected coarse scan")
    ax.legend()
    ...
    ax.set_title("Closed-system corrected fine scan")
    ax.legend()
    ...
    fig.suptitle("Closed-system corrected CZ: two-stage scan")
    fig.tight_layout()

    output_path = artifacts / "closed_system_cz_v2_two_stage_summary.png"
